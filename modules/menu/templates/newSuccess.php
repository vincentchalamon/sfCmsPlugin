...
<?php $sf_response->addMeta('title', 'Administration | '.__('Arborescence', array(), 'messages').' | '.__('Nouveau menu', array(), 'messages')) ?>
<?php slot('breadcrumb', array(array('url' => '@menu', 'label' => __('Arborescence', array(), 'messages')), array('url' => '@menu_new', 'label' => __('Nouveau menu', array(), 'messages')))) ?>
<?php include_partial('menu/assets') ?>
<?php include_partial('menu/flashes') ?>

<div class="contentcontainer">
  <div class="headings">
    <h2><?php echo __('Nouveau menu', array(), 'messages') ?></h2>
  </div>
