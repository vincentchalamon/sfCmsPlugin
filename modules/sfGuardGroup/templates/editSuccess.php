...
<?php $sf_response->addMeta('title', 'Administration | '.__('Groupes d\'utilisateurs', array(), 'messages').' | '.__('Edition de "%%name%%"', array('%%name%%' => $sf_guard_group->getName()), 'messages')) ?>
<?php slot('breadcrumb', array(array('url' => '@sf_guard_group', 'label' => __('Groupes d\'utilisateurs', array(), 'messages')), array('url' => '@sf_guard_group_edit?id='.$sf_request->getParameter('id'), 'label' => __('Edition de "%%name%%"', array('%%name%%' => $sf_guard_group->getName()), 'messages')))) ?>
<?php include_partial('sfGuardGroup/assets') ?>
<?php include_partial('sfGuardGroup/flashes') ?>

<div class="contentcontainer">
  <div class="headings">
    <h2><?php echo __('Edition de "%%name%%"', array('%%name%%' => $sf_guard_group->getName()), 'messages') ?></h2>
  </div>
