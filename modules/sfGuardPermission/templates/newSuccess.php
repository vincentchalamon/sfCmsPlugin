...
<?php $sf_response->addMeta('title', 'Administration | '.__('Permissions d\'utilisateurs', array(), 'messages').' | '.__('Nouvelle permission', array(), 'messages')) ?>
<?php slot('breadcrumb', array(array('url' => '@sf_guard_permission', 'label' => __('Permissions d\'utilisateurs', array(), 'messages')), array('url' => '@sf_guard_permission_new', 'label' => __('Nouvelle permission', array(), 'messages')))) ?>
<?php include_partial('sfGuardPermission/assets') ?>
<?php include_partial('sfGuardPermission/flashes') ?>

<div class="contentcontainer">
  <div class="headings">
    <h2><?php echo __('Nouvelle permission', array(), 'messages') ?></h2>
  </div>
